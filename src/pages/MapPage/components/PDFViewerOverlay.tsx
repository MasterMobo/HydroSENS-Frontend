...
export function PDFViewerOverlay({ pdfUrl, onClose, isOpen }: PDFViewerOverlayProps) {
  ...
  return (
    <AnimatePresence>
      {isOpen && (
        ...
        >
          <div className="bg-white rounded-lg shadow-2xl w-[90vw] max-w-6xl h-[90vh] flex flex-col">
            {/* Header */}
            <div className="flex items-center justify-between p-4 border-b bg-gray-50 rounded-t-lg">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h2 className="text-lg font-semibold text-gray-800">RSS HYDROSENS</h2>
                  <p className="text-sm text-gray-600">Environmental Monitoring Report</p>
                </div>
              </div>
